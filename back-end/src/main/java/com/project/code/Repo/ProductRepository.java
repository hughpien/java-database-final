...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    // public List<Product> findByNameAndCategory(@Param("storeId") Long storeId,
    // @Param("pname") String pname, @Param("category") String category);
    ...
    // public List<Product> findProductByCategory(@Param("storeId") Long storeId,
    ...
    // public List<Product> findProductBySubNameAndCategory(@Param("pname") String
    // pname, @Param("category") String category);
